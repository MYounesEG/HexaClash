...
void FIGHT(Takim* insan_imparatorlugu,Takim* ork_legi)
{
    ...
    do
    {
        ...
        for (int i=0; i< insan_imparatorlugu->birimSayisi ; i++) //to-do (delete this after debug)
        {
            ...
            printf("\nsalidiri= %f\n",insan_imparatorlugu->birimler[i].saldiri);
            printf("\nsavunma= %f\n",insan_imparatorlugu->birimler[i].savunma);
            printf("\nsaglik= %f\n",insan_imparatorlugu->birimler[i].saglik);
            printf("\nkritik_sans= %f\n",insan_imparatorlugu->birimler[i].kritik_sans);
        }
        printf("-----------------------------");
        for (int i=0; i< ork_legi->birimSayisi ; i++) //to-do (delete this after debug)
        {
            ...
            printf("\nsalidiri= %f\n",ork_legi->birimler[i].saldiri);
            printf("\nsavunma= %f\n",ork_legi->birimler[i].savunma);
            printf("\nsaglik= %f\n",ork_legi->birimler[i].saglik);
            printf("\nkritik_sans= %f\n",ork_legi->birimler[i].kritik_sans);
        }
